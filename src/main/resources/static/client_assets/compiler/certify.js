...
submit.addEventListener("click", async function () {
    if (check == number_of_assignments.value) {
        ...
        submissionInputs.forEach(input => {
            const submissionValue = input.value;
            submissionValues.push(submissionValue);
        });
        ...
        console.log("Submission_Kit Status: " + JSON.stringify(result));
    } else {
          ...
          `;
           ...
           `;
                                ...
                                try {
                                    ...
                                    if (!nextTab) {
                                        nextTab = document.querySelector('.nav-item:first-child');
                                    }
