package com.example.coderlab.event.listener;
...
public class RegistrationCompleteEventListener implements ApplicationListener<RegistrationCompleteEvent> {
    ...
    mailContentBuilder.append("<h1>Coder'sLab</h1><hr>");
    mailContentBuilder.append("<h3>Xin chào, " + theUser.getFullName() + "</h3>");
    mailContentBuilder.append("<p>Cám ơn bạn đã đăng ký tại khoản tại Coder'sLab. Để xác nhận việc đăng ký vui lòng ấn vòng đường link bên dưới:</p>");
